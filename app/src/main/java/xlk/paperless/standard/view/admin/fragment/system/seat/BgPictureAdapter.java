 ...
 * @desc
 */
public class BgPictureAdapter extends BaseQuickAdapter<InterfaceFile.pbui_Item_MeetDirFileDetailInfo, BaseViewHolder> {
    private int selectedId;

    public BgPictureAdapter(int layoutResId, @Nullable List<InterfaceFile.pbui_Item_MeetDirFileDetailInfo> data) {
    ...
    public InterfaceFile.pbui_Item_MeetDirFileDetailInfo getSelectPic() {
