...
public class DialogUtil {
    ...
    public static void createDialog(Context cxt, int title, int positive, int negative, @NonNull onDialogClickListener listener) {
        createDialog(cxt, cxt.getString(title), cxt.getString(positive), cxt.getString(negative), listener);
    }

    public static void createDialog(Context cxt, String title, String positive, String negative, @NonNull onDialogClickListener listener) {
